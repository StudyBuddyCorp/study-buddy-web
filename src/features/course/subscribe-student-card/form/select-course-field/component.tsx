          ...
          <Popover>
              ...
              <FormControl>
                <Button
                  ...
                  {field.value
                    ...
                    : t(
                      'student.subscribe-card.form.select-course.default-value',
                    )}
            ...
            <PopoverContent className='w-full p-0'>
              <Command>
                <CommandInput
                  placeholder={t(
                    'student.subscribe-card.form.select-course.search',
                  )}
                  className='h-9'
                />
                <CommandEmpty>
                  {t('student.subscribe-card.form.select-course.empty-value')}
                </CommandEmpty>
                <CommandList>
                  <CommandGroup>
                    {courses.map(course => (
